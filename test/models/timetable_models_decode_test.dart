...
void main() {
  group('student timetable model decoding', () {
    test(
      'ignores legacy date exception JSON and keeps legacy courses compatible',
      () {
        ...
        final customReminder = legacy.copyWith(
        ...
        expect(customReminder.toJson(), isNot(contains('dateExceptions')));
        expect(
